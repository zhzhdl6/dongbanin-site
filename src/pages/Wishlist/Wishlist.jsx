...
const mockWishlist = [
  { id: 201, categoryId: 1, type: '카페', pets: '둘다', name: '숲속댕냥 정원 카페', tags: ['실내 운동장', '주차'], reqs: ['캐리어 필수'], imgBg: '#FFD1A9', emoji: '☕' },
  { id: 203, categoryId: 1, type: '카페', pets: '반려묘', name: '묘생낙원 캣캉스 라운지', tags: ['반려동물존'], reqs: ['유모차 필수'], imgBg: '#C9E9FF', emoji: '🐈' },
  { id: 205, categoryId: 4, type: '펜션', pets: '반려견', name: '포근 댕댕 풀빌라', tags: ['수영장', '바베큐'], reqs: ['대형견 불가'], imgBg: '#E2CBF7', emoji: '🏡' }
];
