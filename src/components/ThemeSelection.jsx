...
function ThemeSelection() {
  const originalThemes = [
    { id: 1, name: '초대형견 OK!\n프리미엄 숙소', desc: '40kg 몸짱 댕댕이도 대환영', emoji: '🦍', color: '#E3DAFF' },
    { id: 2, name: '반려묘 동반\n캣캉스 추천 카페', desc: '집사와 냥이 모두 행복한 쉼터', emoji: '🐈', color: '#C9E9FF' },
    { id: 3, name: '댕댕이와 한잔\n심야 애견 포차', desc: '늦은 밤에도 걱정 없는 아지트', emoji: '🍻', color: '#FCD8E3' },
    { id: 4, name: '비와도 달린다!\n대형 실내 운동장', desc: '날씨 구애 없는 오프리시 공간', emoji: '☔', color: '#FFF5C3' }
  ];
